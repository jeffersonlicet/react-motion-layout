...
function Feature({
  ...
  return (
    <div className={classnames('w-1/3 p-4 pt-8 pb-2 border border-gray-200 shadow-sm mr-2 rounded-lg flex flex-col items-center ml-2 text-center', styles.feature)}>
